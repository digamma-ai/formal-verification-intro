...
\begin{frame}{Memory store bug or implicit restriction?}

We have demonstrated that when \texttt{end} pointer is treated as part of the parsed string, there is a bug where it gets ovewer
